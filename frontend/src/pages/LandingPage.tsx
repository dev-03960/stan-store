...
const steps = [
    { step: '01', title: 'Sign Up', description: 'Create your free account in seconds with Google Sign-In.' },
        ...
        <div className="overflow-hidden">
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center px-4 pt-8 pb-20">
                ...
                <div className="relative z-10 max-w-5xl mx-auto text-center">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-100 to-orange-100 px-5 py-2 mb-8 border border-pink-200/50">
                    ...
                    <h1 className="font-heading text-5xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight tracking-tight mb-6">
                        Turn Your Audience Into
                        <span className="block bg-gradient-to-r from-pink-500 via-orange-500 to-amber-500 bg-clip-text text-transparent">
                            Revenue ✦
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a
                            href="/login"
                            className="group relative inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 via-orange-500 to-amber-500 px-8 py-4 text-lg font-bold text-white shadow-lg shadow-orange-500/25 transition-all hover:shadow-xl hover:shadow-orange-500/30 hover:scale-105"
                        >
                        ...
                        <a
                            href="/login"
                            className="inline-flex items-center gap-2 rounded-full border-2 border-gray-200 bg-white px-8 py-4 text-lg font-semibold text-gray-700 transition-all hover:border-pink-300 hover:bg-pink-50 hover:text-pink-700"
                        >
                            Sign In →
                        </a>
                    </div>
                    ...
                    <div className="mt-12 flex items-center justify-center gap-2 text-gray-500 text-sm">
                        <div className="flex -space-x-2">
                            {[
                                'bg-pink-400', 'bg-orange-400', 'bg-amber-400', 'bg-emerald-400', 'bg-violet-400'
                            ].map((color, i) => (
                                <div
                                    key={i}
            ...
            {/* ════════════════ STATS BANNER ════════════════ */}
            <section className="relative py-16 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
                <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
                    {stats.map((stat) => (
                        <div key={stat.label} className="text-center">
                            <div className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-pink-400 to-orange-400 bg-clip-text text-transparent">
                                {stat.value}
                            </div>
            ...
            <section className="py-24 px-4 bg-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 rounded-full bg-purple-50 px-4 py-1.5 mb-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature) => (
                            <div
                                key={feature.title}
                                className="group relative p-8 rounded-2xl border border-gray-100 bg-white hover:border-transparent hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-300"
                            >
            ...
            <section className="py-24 px-4 bg-gradient-to-b from-gray-50 to-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 rounded-full bg-orange-50 px-4 py-1.5 mb-4">
                            <Star className="w-4 h-4 text-orange-500" />
                            <span className="text-sm font-semibold text-orange-600">Simple Setup</span>
                        </div>
                        <h2 className="font-heading text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {steps.map((s, i) => (
                            <div key={s.step} className="relative text-center group">
                                {/* Connector line */}
                                {i < steps.length - 1 && (
                                    <div className="hidden lg:block absolute top-10 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-pink-200 to-orange-200" />
                                )}
                                <div className="relative z-10 inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-500 to-orange-500 text-white text-2xl font-extrabold mb-5 shadow-lg shadow-pink-500/20 group-hover:scale-110 transition-transform">
                                    {s.step}
                                </div>
            ...
            <section className="py-24 px-4 bg-white">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="font-heading text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4">
                            Why Creators Love <span className="bg-gradient-to-r from-pink-500 to-orange-500 bg-clip-text text-transparent">Mio Store</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        {[
                            ...
                            <div key={i} className="flex items-start gap-4 p-5 rounded-xl hover:bg-gray-50 transition-colors">
            ...
            <section className="py-24 px-4 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-pink-500 via-orange-500 to-amber-500" />
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(255,255,255,0.2),transparent_60%)]" />

                <div className="relative z-10 max-w-3xl mx-auto text-center">
                    <h2 className="font-heading text-4xl sm:text-5xl font-extrabold text-white mb-6 leading-tight">
                    ...
                    <a
                        href="/login"
                        className="inline-flex items-center gap-2 rounded-full bg-white px-10 py-4 text-lg font-bold text-orange-600 shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
                    >
                        <Rocket className="w-5 h-5" />
                        Get Started Free
