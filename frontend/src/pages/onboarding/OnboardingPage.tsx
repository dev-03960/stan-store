                ...
                <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-10 shadow-xl">
                    ...
                    <div className="mt-8 space-y-6">
                        <div>
                            ...
                            <div className="mt-1 flex rounded-md shadow-sm">
                                ...
                                <input
                                    ...
                                    name="username"
                                    id="username"
                                    className={`block w-full min-w-0 flex-1 rounded-none rounded-r-md border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-400 focus:border-[#6786f5] focus:ring-[#6786f5] sm:text-sm ${usernameError ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''
                                        }`}
                        ...
                        <button
                            ...
                            className="flex w-full justify-center rounded-md border border-transparent bg-[#6786f5] px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-[#5570e0] focus:outline-none focus:ring-2 focus:ring-[#6786f5] focus:ring-offset-2 disabled:bg-purple-300"
                        >
                            Claim & Continue
                        </button>
                    </div>
                ...
                <div className="mt-8 space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-[#6786f5] focus:outline-none focus:ring-[#6786f5] sm:text-sm"
                        />
                    </div>
                        ...
                        <div className="mt-2 space-y-3">
                            {socialLinks.map((link, index) => (
                                <div key={index} className="flex gap-2">
                                    <select
                                        ...
                                        className="rounded-md border border-gray-300 py-2 pl-3 pr-8 text-sm focus:border-[#6786f5] focus:outline-none focus:ring-[#6786f5]"
                                    >
                                    ...
                                    <input
                                        ...
                                        placeholder="https://..."
                                        className="block w-full flex-1 rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-[#6786f5] focus:outline-none focus:ring-[#6786f5]"
                                    />
                                    <button
                            ...
                            {socialLinks.length < 5 && (
                                <button
                                    ...
                                    className="text-sm font-medium text-[#6786f5] hover:text-[#6786f5]"
                                >
                                    + Add Social Link
                                </button>
                            )}
                    ...
                    <button
                        ...
                        className="flex w-full justify-center rounded-md border border-transparent bg-[#6786f5] px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-[#5570e0] focus:outline-none focus:ring-2 focus:ring-[#6786f5] focus:ring-offset-2"
                    >
                        Complete Setup
                    </button>
                </div>
